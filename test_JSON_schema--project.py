...
import unittest
import json, sys
from main import schemaType,schema_data, message, input_file_name, input_file_name_2, input_file_path, input_file_path_2, output_file_name, output_file_path, output_file_name_2, output_file_path_2, addToSchema
import results
...
#The function test for the correct filename
...
#The function test for the correct file path
...
#The function test for enum                
        def test_for_enum(self):
                ...
                outcome = schemaType(["string_1","string_2"])
...
#The function test for an array                 
        def test_for_array(self):
                ...
                outcome = schemaType([{"key_1": "value_1"}])
